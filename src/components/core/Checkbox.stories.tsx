 ...
 * Disables cssVariables to bypass MUI v7's CSS variables mode (which
 * requires the colorSchemes API for dark mode) and provides explicit
 * dark-mode background/text values to override light-mode defaults.
 */
